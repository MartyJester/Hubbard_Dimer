...
for temp in tau_values:
    plt.plot(np.linspace(0, 100, 50), rho_vec(0.5, np.linspace(0, 100, 50), 1, temp, 0.5), label=temp)
plt.xlabel('v')
plt.legend()
plt.ylabel('Density')
plt.show()
...
for temp in tau_values:
    plt.plot(np.linspace(0, 100, 50), kinetic_vec(0.5, np.linspace(0, 100, 50), 1, temp, 0.5), label=temp)
plt.xlabel('v')
plt.legend()
plt.ylabel('kin')
plt.show()
...
for temp in tau_values:
    plt.plot(np.linspace(0, 100, 50), vee_vec(0.5, np.linspace(0, 100, 50), 1, temp, 0.5), label=temp)
plt.xlabel('v')
plt.legend()
plt.ylabel('vee')
plt.show()
